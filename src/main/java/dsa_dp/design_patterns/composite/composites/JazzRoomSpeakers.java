package dsa_dp.design_patterns.composite.composites;

import dsa_dp.design_patterns.composite.SpeakerComponent;

import java.util.ArrayList;

public class JazzRoomSpeakers extends SpeakerComponent {
    private ArrayList<SpeakerComponent> speakers = new ArrayList<>(5);


    public JazzRoomSpeakers(String name) {
        super(name);
    }
